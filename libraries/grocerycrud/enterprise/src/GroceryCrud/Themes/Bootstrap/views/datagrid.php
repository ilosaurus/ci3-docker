<?php
    ...
    $this->setCssFile($this->_assetsFolder.'css/grocery-crud-v2.7.13.20e735b.css');
    ...
    $this->setJavaScriptFile($this->_assetsFolder . 'js/build/grocery-crud-v2.7.13.20e735b' . $minify_or_not . '.js');
